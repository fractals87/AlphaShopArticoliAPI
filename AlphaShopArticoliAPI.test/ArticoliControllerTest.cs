...
namespace AlphaShopArticoliAPI.test
{
    public class ArticoliControllerTest
    {
        ...
        public async Task TestGetArticoloByCode()
        {
            ...
            // Act
            var response = await controller.GetArticoloByCode(CodArt,"1") as ObjectResult;
        ...
        public async Task TestErrSelArticoliByDescrizione()
        {
            ...
            // Act
            var actionResult = await controller.GetArticoliByDesc(Descrizione,"1","1");
            dbContext.Dispose();
        ...
        public async Task TestSelArticoloByEan()
        {
            ...
            // Act
            var response = await controller.GetArticoloByEan(Ean,"1") as ObjectResult;
            var value = response.Value as ArticoliDto;
